...
if (isset($_POST["sub"], $_POST["title"], $_POST["editor"], $_POST["time"], $_POST["tags"])) {
    ...
    Update_Blog($id, $title, $editor, $writer, $time, $tags, $date, $file_name);
...
<div class="container">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <textarea name="editor" id="editor1"><?= $blog['caption'] ?></textarea>
        <script>
        ...
        <!--        <input name="writer" type="text" value="--><? //= $blog['writer'] ?><!--">-->
        <input name="time" type="number" value="<?= $blog['readtime'] ?>" placeholder="زمان تقریبی مطالعه"
               class="form-control">
