...
<div class="container">
    <div class="col-12 col-lg-8">
        <div class="blog">
            <h1>طرز تهیه چیزکیک کدوحلوایی</h1>
            <div class="writer">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                </svg><span>فریده ذاکر</span>-1401/03/03
            </div>
            <div class="comment">
                ...
                </svg>خواندن این مقاله 10دقیقه زمان می برد
            </div>
            <img src="../image/2.jpg" alt="" width="100%" height="600px">
      ...
      <div class="col-12 col-lg-8">
          <div class="comment">
            ...
            <form method="POST">
                ...
                <input style="margin-top: 25px;" type="submit" class="btn btn-success" value="ثبت دیدگاه">
            </form>
            <div class="">
              <p>رامین پورمحمد</p>
              <span>واقعا خوب واموزنده بود</span>
            </div>
          </div>
      </div>
</div>
